...
for i in range(N):
    print i, "------"
    first_guess = {'seed': i}
    S = ControlSystem(model_rhs, a=Ta, b=Tb, xa=xa, xb=xb, ua=ua, ub=ub, use_chains=False, first_guess=first_guess, ierr=None, maxIt=3, eps=1e-1, sol_steps=100, reltol=1e-3, accIt=3)
