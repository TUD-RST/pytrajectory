...
copyright = '2015-2018, Andreas Kunze, Carsten Knoll'
...
latex_documents = [
  ('index', 'pytrajectory.tex', 'pytrajectory Documentation',
   'Andreas Kunze', 'manual'),
]
...
man_pages = [
    ('index', 'pytrajectory', 'pytrajectory Documentation',
     ['Andreas Kunze'], 1)
]
...
texinfo_documents = [
  ('index', 'pytrajectory', 'pytrajectory Documentation',
   'Andreas Kunze', 'pytrajectory', 'One line description of project.',
   'Miscellaneous'),
]
